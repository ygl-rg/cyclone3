``cyclone.web`` --- ``RequestHandler`` and ``Application`` classes
==================================================================

.. automodule:: cyclone.web
   ...
   .. autoclass:: Application
	 ...
	 * ``xheaders``: If ``True`` the application uses ``X-Real-IP``
	   and ``X-Forwarded-For`` HTTP headers. Use this when your server
